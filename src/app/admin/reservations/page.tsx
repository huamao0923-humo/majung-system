...
export default async function AdminReservationsPage({
  ...
  searchParams: Promise<{ range?: string; date?: string; status?: string }>;
}) {
                  ...
                  {rows.map((r) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span
                          className="w-20 text-center text-xs px-2 py-1 rounded-full font-medium"
                        ...
                        <div className="w-28">
                          <ReservationActions reservation={{ id: r.id, status: r.status }} />
                        </div>
                      </div>
                    );
                  })}
