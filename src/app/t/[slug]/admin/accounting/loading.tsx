    ...
    <div className="p-6 space-y-5 max-w-4xl mx-auto animate-pulse">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="rounded-2xl h-28" style={{ background: "rgba(139,0,0,0.04)", border: "1px solid rgba(212,175,55,0.1)" }} />
        ))}
      </div>
      <div className="rounded-2xl h-48" style={{ background: "rgba(139,0,0,0.04)", border: "1px solid rgba(212,175,55,0.1)" }} />
          ...
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="px-5 py-3 flex items-center gap-4">
              <div className="flex-1 space-y-2">
                ...
                <div className="h-3 w-36 rounded" style={{ background: "rgba(139,0,0,0.04)" }} />
              </div>
              <div className="h-4 w-16 rounded" style={{ background: "rgba(139,0,0,0.05)" }} />
