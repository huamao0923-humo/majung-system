    ...
    <div className="p-6 space-y-5 max-w-5xl mx-auto animate-pulse">
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          ...
          <div className="h-4 w-48 rounded-lg" style={{ background: "rgba(139,0,0,0.05)" }} />
        </div>
          ...
          {Array.from({ length: 8 }).map((_, i) => (
            <div key={i} className="px-5 py-3 flex items-center gap-4">
              <div className="flex-1 space-y-2">
                ...
                <div className="h-3 w-16 rounded" style={{ background: "rgba(139,0,0,0.04)" }} />
              </div>
              <div className="h-4 w-14 rounded" style={{ background: "rgba(139,0,0,0.05)" }} />
              <div className="h-4 w-14 rounded" style={{ background: "rgba(139,0,0,0.05)" }} />
              ...
              <div className="h-6 w-14 rounded" style={{ background: "rgba(139,0,0,0.04)" }} />
              <div className="h-8 w-28 rounded-xl" style={{ background: "rgba(139,0,0,0.05)" }} />
            </div>
          ))}
        </div>
      </div>
